    ...
    createErrStatus() {
        ...
        let viewContainer = {
            MG00001: {
                ...
                message: 'ขออภัย คุณไม่สามารถเล่นเกมได้ กรุณารอการปรับยอดเงินฝาก',
...

                            {
                                (Array.isArray(lotteryHistory) && lotteryHistory.length > 0)
                                    ...
                                    <View style={{ height: height * .6 }}>
                                        ...
                                        >
                                            {
                                                lotteryHistory.filter(v => v.prizeName != "Empty Prize").map((v, i) => <View style={[styles.historyHead, {
                                                    marginVertical: 2,
                                                    backgroundColor: i % 2 ? '#FBD893' : '#F2CD87'
                                                }]}>
                                                    <View style={[styles.historyHeadView, styles.historyHeadView1]}>
                                                        <Text style={[styles.historyHeadText, { color: '#000000' }]}>{moment(v.applyDate).format('YYYY-MM-DD HH:MM')}</Text>
                                                    </View>
                                                    <View style={[styles.historyHeadView, styles.historyHeadView1]}>
                                ...
                                <View>
                                    <View style={styles.lotteryTrBox}>
                                        <View style={[styles.lotteryTr, styles.lotteryTr1]}>
                                            <Text style={styles.lotteryTrText}>{`ยอดฝากสะสม\n(บาท)`}</Text>
                                        </View>
                                        <View style={[styles.lotteryTr, styles.lotteryTr2]}>
                                            <Text style={styles.lotteryTrText}>จํานวนครั้ง</Text>
                                        </View>
                                        <View style={[styles.lotteryTr, styles.lotteryTr3]}>
                                            <Text style={styles.lotteryTrText}>ระดับสมาชิก</Text>
                                        </View>
                                        <View style={[styles.lotteryTr, styles.lotteryTr4]}>
                                            <Text style={styles.lotteryTrText}>สะสมสิทธิ์สูงสุด</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.lotteryBody}>
                                        ...
                                        <View style={[styles.lotteryTrBox2, styles.lotteryTr4, styles.lotteryTrBox3]}>
                                            <Text style={[styles.lotteryTrText, styles.lotteryTrText1]}>สมาชิกทกท่าน</Text>
                                        </View>
                    ...
                    <View style={styles.conatienrOne}>
                        <View style={styles.userMoneyBox}>
                            <View style={styles.userMoneyBoxWrap}>
                                <Text style={styles.userMoneyBoxWrapText1}>ยอดฝากรวมวันนี้</Text>
                                <TouchableOpacity style={styles.resetImgWrap}
                                    onPress={this.getMemberProgress.bind(this, true)}
                                >
                                    <Text style={[styles.userMoneyBoxWrapText1, styles.userMoneyBoxWrapText2]}>{totalDepositedDaily}</Text>
                                    <Image
                                        resizeMode='stretch'
                            ...
                            <View style={styles.userMoneyBoxWrap}>
                                <Text style={styles.userMoneyBoxWrapText1}>สิทธิ์ในการเปิดกล่อง</Text>
