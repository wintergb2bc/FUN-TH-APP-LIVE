...
public class PackageList {
  ...
  public ArrayList<ReactPackage> getPackages() {
    return new ArrayList<>(Arrays.<ReactPackage>asList(
      ...
      new CodePush(getResources().getString(com.F1M2LIVE.soexample.R.string.CodePushDeploymentKey), getApplicationContext(), com.F1M2LIVE.soexample.BuildConfig.DEBUG),
